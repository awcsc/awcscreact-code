...
const RegUsers = () => {
  ...
  const deleteUser = async (user) => {
    setLoader(true);
    try {
      await axios.post(`${baseUrl}/api/deluserteachers`, { id: user.id });
  ...
  const disableUser = async (id) => {
    setLoader(true);
    try {
      await axios.post(`${baseUrl}/api/endisuserteachers`, {
        id: id,
        disabled: true,
      });
  ...
  const resetPassword = async (user) => {
    ...
    try {
      ...
      await axios.post(`${baseUrl}/api/updateuserteachers`, user);
  ...
  const resetSchoolPassword = async (user) => {
    ...
    try {
      ...
      user.password = password;
      await axios.post(`${baseUrl}/api/updateuserschools`, user);
